  ...
  return (
    <AnimatePresence mode='wait'>
        <div key= {pathName} className=" w-screen h-screen  ">
            <motion.div className=' h-screen w-screen fixed bg-pink-800 z-50 rounded-b-[100px]' 
                animate={{height: '0vh'}}
                exit={{height: '140vh'}}
            ...
            <motion.div className=' h-screen w-screen fixed bg-pink-800 z-40 rounded-t-[100px] bottom-0' 
