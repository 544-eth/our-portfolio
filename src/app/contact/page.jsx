    ...
    <motion.div 
         ...
         transition={{duration: 1.2}}>
          <div className=' h-full flex flex-col lg:flex-row px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 '>
            ...
            {/* FORM CONTAINER */}
              <form onSubmit={sendEmail} ref={form} className=' lg:h-full lg:w-1/2 bg-gradient-to-bl from-purple-100 to-blue-100 rounded-xl text-xl flex flex-col gap-8 justify-center w-full h-full p-5 lg:p-20 '>
